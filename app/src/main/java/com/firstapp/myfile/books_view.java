...
public class books_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_layout=(LinearLayout)findViewById(R.id.buttonview_layout);
       /* if(row_length_str.equals("7") && column_length_str.equals("8")) {
            width = 110;
            height=130;
            row_length=7;
    ...
    private void domain_button_view(int size,int row_length,int column_length,int width,int height,int margin) {
        for(int i=0;i<row_length;i++) {
            ...
            for (int j = 0; j < column_length; j++) {
                Button single_btn = new Button(books_view.this);
